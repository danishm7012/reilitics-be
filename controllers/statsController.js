...
const getRentalJson = asyncHandler(async (req, res) => {
  ...
  const rentaljson = await rentalJson.map((item) => ({
    ...
    "2018-01": item["2018-01"],
    "2018-12": item["2018-12"],
    "2019-01": item["2019-01"],
    "2019-12": item["2019-12"],
    "2020-01": item["2020-01"],
    "2020-12": item["2020-12"],
    "2021-01": item["2021-01"],
    "2021-12": item["2021-12"],
  }));
